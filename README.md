...
See [[deployment.md]](https://github.com/raychour/MP3-to-MIDI-Percussion-Generator/blob/main/midi-generator/deployment.md) for detailed instructions on how to deploy this on a Proxmox LXC container with GPU passthrough.
